    ...
    <div>
      ...
      <div className="mt-24 py-8 leading-normal">
        <div className="container">
          ...
          this Website, under these Terms, Multimeta and/or its licensors own
          all rights to the intellectual property and material contained in this
          ...
          <br />
          - using this Website in any way that is, or maybe, damaging to this
          Website;
          <br />
          ...
          Multimeta may further restrict access by you to any areas of this
          ...
          it, you grant Multimeta a non-exclusive, worldwide, irrevocable,
          ...
          party’s rights. Multimeta reserves the right to remove any of Your
          Content from this Website at any time, and for any reason, without
          notice.
          <br />
          5. No warranties
          <br />
          This Website is provided “as is,” with all faults, and Multimeta makes
          ...
          <br />
          In no event shall Multimeta, nor any of its officers, directors, and
          ...
          under contract, tort or otherwise, and Multimeta, including its
          ...
          7. Indemnification
          <br />
          You hereby indemnify to the fullest extent Multimeta from and against
          ...
          <br />
          Multimeta is permitted to revise these Terms at any time as it sees
          ...
          10. Assignment
          <br />
          [Sender.Company] shall be permitted to assign, transfer, and
          ...
          this Website, constitute the entire agreement between Multimeta and
          ...
          laws of Singapore, and you submit to the non-exclusive jurisdiction of
          the Republic of Singapore for the resolution of any disputes.
        </div>
      </div>
      <Footer />
    </div>
...
export default React.memo(TermConditionsWrapper);
